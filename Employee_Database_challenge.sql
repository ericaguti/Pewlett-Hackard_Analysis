...
--Create a query thata will returen only the information relevant to the Sales team.
SELECT ce.emp_no,
	   ce.first_name,
	   ce.last_name,
	    d.dept_name,
...
--Create a query thata will returen only the information relevant to the Sales and Development team.
SELECT ce.emp_no,
	   ce.first_name,
	   ce.last_name,
	    d.dept_name,
